    ...
    <div class="wrapper_log">
        ...
        <div id="msform">
            ...
            <fieldset id="passwordform">
                ...
                <form method="post" action="{{url('/')}}/brands/password">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="brand_user_id" value="{{ $brand_user_id }}">
                    <div class="loginMsg">
                        <label> Great! Now create a password for your Whisttler profile</label>
                    </div>
                    <input class="getInput1" type="password" placeholder="Enter your password" name="password" />
                    <input class="getInput1" type="password" name="confirm_password" placeholder="Retype the password and make sure its the same" />
                    <button type="submit" value="Next" class="next nextBtn">Continue to Category</button>
                </form>
            </fieldset>
        </div>
    </div>
