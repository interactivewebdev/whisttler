...
@section('content')
    ...
    <section class="container flex about_banner">
        <div class="wrapper_log">
            <form method="post" action="{{url('/brands/signupcategory')}}">
                {{ csrf_field() }}
                ...
                <div>
                    <fieldset>
                        <div class="loginMsg">
                            <label class="selectCateTittle"> Please select the topic about which you post. This will be your categories.</label>
                        </div>
                        ...
                        <div class="displyFlex">
                            ...
                            @foreach($categories as $key => $category)
                                <li><input type="checkbox" name="category[]" id="cb{{$key}}" value="{{$category->id}}" style="visibility: hidden" />
                        ...
                        <button type="submit" class="next influContinueBtn displyInital">Continue to Profile Details</button>
