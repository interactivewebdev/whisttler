...
@section('content')
    ...
    <section class="container flex about_banner">
        <div class="wrapper_log">
            <form method="post" action="{{url('/influencers/secondarycategory')}}">
                {{ csrf_field() }}
                ...
                <div>
                    <fieldset>
                        <div class="loginMsg">
                            <label class="selectCateTittle"> Please select the topic about which you post. This will be your Secondary Category.</label>
                        </div>
                        ...
                        <button type="submit" class="next influContinueBtn displyInital">Continue to Dashboard</button>
