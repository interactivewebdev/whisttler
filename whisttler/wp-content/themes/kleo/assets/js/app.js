...
(function ($) {
    ...
    var kleoShop = {
        ...
        init: function () {
            ...
            if (kleoShop.wooThumbs.length < 2) {
                $(".woo-main-image-nav").hide();
            }

            if (kleoShop.wooThumbs.length) {
                ...
                $(".kleo-woo-next").on('click', function (e) {
                    ...
                    e.preventDefault();
	                kleoShop.wooCarousel.trigger('next');

                    if (kleoShop.wooThumbs.filter('.selected').parent().nextAll(".woocommerce-product-gallery__image:eq(0)").length) {
                        var nextElem = kleoShop.wooThumbs.filter('.selected').parent().nextAll(".woocommerce-product-gallery__image:eq(0)").find('a');
                ...
                $(".kleo-woo-prev").on('click', function (e) {
                    ...
                    e.preventDefault();
	                kleoShop.wooCarousel.trigger('prev');

                    if (kleoShop.wooThumbs.filter('.selected').parent().prevAll(".woocommerce-product-gallery__image:eq(0)").length) {
                        var prevElem = kleoShop.wooThumbs.filter('.selected').parent().prevAll(".woocommerce-product-gallery__image:eq(0)").find('a');
        ...
        setSelected: function (element) {
            kleoShop.wooMainImg.find('img').attr('src', element.attr('href')).removeAttr('srcset').removeAttr('data-src').parent("a").attr("href", element.data('big-img'));
	        kleoShop.wooMainImg.siblings('img').attr('src', element.attr('href'));
